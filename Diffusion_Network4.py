...
if __name__ == '__main__': #network 3
    ...
    if dataset_name == "crossroad":
        torch.save(model.state_dict(), './checkpoint/diffusion/diffusion_model_network4_cross.pth')
    if dataset_name == "train_station":
        torch.save(model.state_dict(), './checkpoint/diffusion/diffusion_model_network4_train.pth')
